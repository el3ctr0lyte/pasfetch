...
begin
  ...
  //i don't know how neofetch does it. This gets it almost spot on but when the PC has been running for awhile,
  //then pasfetch shows more than what neofetch show. This tells me that i have to subtract another thing that
  //is initially 0 then builds up when the PC has been on for a while but i don't know what that is.
